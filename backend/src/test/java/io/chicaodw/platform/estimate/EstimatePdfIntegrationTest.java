...
class EstimatePdfIntegrationTest extends AbstractIntegrationTest {
    ...
    void downloadPdf_withValidLogo_stillSucceeds() throws Exception {
        ...
        var pngOut = new java.io.ByteArrayOutputStream();
        javax.imageio.ImageIO.write(image, "png", pngOut);
        var logoFile = new MockMultipartFile("file", "logo.png", "image/png", pngOut.toByteArray());
