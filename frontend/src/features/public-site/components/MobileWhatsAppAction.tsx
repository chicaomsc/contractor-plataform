...
export function MobileWhatsAppAction({ site }: MobileWhatsAppActionProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-40 inline-flex h-14 w-14 items-center justify-center bg-primary text-primary-foreground no-underline shadow-sm md:hidden"
    >
